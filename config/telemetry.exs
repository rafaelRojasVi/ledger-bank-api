    ...
    resource_attributes:
      %{
        ...
        "deployment.environment" =>
          System.get_env("DEPLOYMENT_ENVIRONMENT", Mix.env() |> to_string()),
        ...
        "service.instance.id" =>
          System.get_env("HOSTNAME", System.get_env("POD_NAME", "unknown")),
        ...
        "cloud.availability_zone" =>
          System.get_env("CLOUD_AZ", System.get_env("DEPLOYMENT_ZONE")),
